			...
			<main className="column is-3 is-offset-4">
				...
				<form name="form" onSubmit={this.handleSubmit} noValidate={true}>
					...
					<div className="field">
						...
						{
							!validPassword &&
							<p className="help is-danger">Passwords must be at least 8 characters long, with at least one lower-case character, one upper-case character, one digit and one special character</p>
						}
						{
